...
def test_standardize_tags():
    ...
    observed = socrata.standardize(original)
    expected = {
        u'creator_id': u'https://healthmeasures.aspe.hhs.gov/d/67n2-h4v3',
        u'creator_name': u'UNDP Transparency',
        u'date': datetime.datetime(2012, 11, 29, 23, 45, 26, tzinfo = UTC),
        u'download_url': u'https://data.undp.org/resource/mvag-axbk.csv',
        u'tags': set(),
        u'title': u'Projects in Bahamas',
        u'url': u'https://data.undp.org/d/mvag-axbk',
    }
    n.assert_dict_equal(observed, expected)
